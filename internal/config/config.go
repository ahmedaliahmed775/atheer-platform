...
// AdapterConfig holds configuration for a single wallet adapter
...
// AdaptersConfig holds all wallet adapter configurations
type AdaptersConfig struct {
        JEEP  AdapterConfig `mapstructure:"jeep"`
        WENET AdapterConfig `mapstructure:"wenet"`
        WASEL AdapterConfig `mapstructure:"wasel"`
}
...
func Load() (*Config, error) {
        ...
        cfg.Adapters = AdaptersConfig{
                JEEP: AdapterConfig{
                        BaseURL:    v.GetString("adapters.jeep.base_url"),
                        APIKey:     v.GetString("adapters.jeep.api_key"),
                        TimeoutSec: v.GetInt("adapters.jeep.timeout_sec"),
                },
                WENET: AdapterConfig{
                        BaseURL:    v.GetString("adapters.wenet.base_url"),
                        APIKey:     v.GetString("adapters.wenet.api_key"),
                        TimeoutSec: v.GetInt("adapters.wenet.timeout_sec"),
                },
                WASEL: AdapterConfig{
                        BaseURL:    v.GetString("adapters.wasel.base_url"),
                        APIKey:     v.GetString("adapters.wasel.api_key"),
                        TimeoutSec: v.GetInt("adapters.wasel.timeout_sec"),
                },
        }

        // Bind adapter env vars
        _ = v.BindEnv("adapters.jeep.base_url", "ATHEER_ADAPTERS_JEEP_BASE_URL")
        _ = v.BindEnv("adapters.jeep.api_key", "ATHEER_ADAPTERS_JEEP_API_KEY")
        _ = v.BindEnv("adapters.wenet.base_url", "ATHEER_ADAPTERS_WENET_BASE_URL")
        _ = v.BindEnv("adapters.wenet.api_key", "ATHEER_ADAPTERS_WENET_API_KEY")
        _ = v.BindEnv("adapters.wasel.base_url", "ATHEER_ADAPTERS_WASEL_BASE_URL")
        _ = v.BindEnv("adapters.wasel.api_key", "ATHEER_ADAPTERS_WASEL_API_KEY")
